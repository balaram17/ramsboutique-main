...
const questions = [
  ...
  ["Where does Rams Boutique deliver?", "Our current service area is based around Visakhapatnam. Delivery availability is confirmed according to the delivery address entered during checkout."],
  ...
  ["How can I contact Rams Boutique?", "Email us at info@ramsboutique.com or use our Contact Us page."],
];
    ...
    <main className="min-h-screen bg-gray-50 py-10">
      <div className="mx-auto max-w-4xl px-4">
        ...
        <section className="rounded-2xl bg-white p-6 shadow-sm md:p-10">
          ...
          <p className="mb-8 text-gray-600">Find answers to common questions about Rams Boutique.</p>
