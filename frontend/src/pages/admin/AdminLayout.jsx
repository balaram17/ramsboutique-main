  ...
  return (
    <div className="min-h-screen flex bg-gray-100">
      <aside className="w-60 bg-[#2b1608] text-white flex flex-col">
        ...
        <button onClick={handleLogout} className="p-5 border-t border-white/10 text-left text-sm flex items-center gap-3 hover:bg-white/5">
...
export default AdminLayout;    return () => {
      clearInterval(timer);
      window.removeEventListener('admin-notifications-updated', loadNotifications);
    };
  }, [loadNotifications]);
